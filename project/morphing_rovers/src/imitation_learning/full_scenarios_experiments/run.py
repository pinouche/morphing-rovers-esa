...
from morphing_rovers.src.imitation_learning.single_scenario_experiments.arc_trajectories import get_coordinates, \
    compute_both_arcs
    ...
    for scenario_n in range(3, 30):
        ...
        for i in range(N_RUNS):
            ...
            for n_iter in range(MAX_TIME, MAX_TIME + 1):
                ...
                network_trainer = OptimizeNetworkSupervised(options, chromosome, scenario_n, training_data)
